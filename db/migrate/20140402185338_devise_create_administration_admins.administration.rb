# This migration comes from administration (originally 20140402182325)
class DeviseCreateAdministrationAdmins < ActiveRecord::Migration
  def change
    create_table(:administration_admins) do |t|
